...
return [
    ...
    */
    ...
    | your application. Using this information, we know which of the
    ...
    */
    ...
    | provides a push and pub/sub messaging system. Laravel makes it easy
    | to interface with Redis database to manipulate sessions, cache, etc.
    |
    */
