...
return [
    ...
    */
    ...
    | to immediately expire when the browser is closed, set that option.
    |
    */
    ...
    */
    ...
    | time a new session cookie is created by the framework for every user.
    |
    */
    ...
    */
    ...
    | do not enable this as other CSRF protection is provided by default.
    |
